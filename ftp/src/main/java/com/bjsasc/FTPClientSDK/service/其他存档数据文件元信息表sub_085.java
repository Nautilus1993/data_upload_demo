 ...
 */
public class 其他存档数据文件元信息表sub_085 {
...
//            }
            ...
            String file = "PA_EN_TGTH_GCYC_00_GCYC_20200817234411_20200817234411_20200817234411_000.raw";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            // 上传文件
            String mainType = "main_002";     // 数据大类：归档数据
            String subType = "sub_002";          // 数据小类：原始数据文件

...
public class 生理数据文件表sub_043 {
    public static void main(String[] args) {
        ...
        try {
            ...
            /************   上传文件    ************/
            // 本地文件名和目录
            String file = "WT_图像_20201030061252_中继.MP4";
            ...
            //归档信息
            BioMedicalFile dataResultAchieveReportFile = new BioMedicalFile();
            dataResultAchieveReportFile.setFileType("数据成果格式");
            dataResultAchieveReportFile.setCabin("cabin_001");
            dataResultAchieveReportFile.setComment("创建人");
            dataResultAchieveReportFile.setDeviceId((short) 1);
            dataResultAchieveReportFile.setFileFullName("类型");
            dataResultAchieveReportFile.setIndentify("版权方");
            dataResultAchieveReportFile.setFlyStage("描述");
            dataResultAchieveReportFile.setFileTime(new Date());
            dataResultAchieveReportFile.setHumanId((byte) 1);
            ...
            String subType = "sub_043";          // 数据小类：原始数据文件

document.write("<script type='text/javascript' src='../static/upload/js/base64.js'></script>");
jQuery(function () {
    var $ = jQuery,
        ...
        contextPath = 'http://10.2.29.102:18090/HTTPServer',
        //分片大小
...
// 文件上传过程中创建进度条实时显示
    ...
    $btnAddDataResultAchieveReportForm.click(function () {
        var form = "<br/>\n" +
            "        <p>ID: <input type=\"text\" name=\"id\"  style=\"display:none\" /></p>\n" +
            "        <p>序号: <input type=\"text\" name=\"fileId\" style=\"display:none\" /></p>\n" +
            "        <p>任务代号: <input type=\"text\" name=\"mission\" value=\"任务代号\"/></p>\n" +
            "        <p>舱段代号: <input type=\"text\" name=\"section\" value=\"舱段代号\"/></p>\n" +
            "        <p>数据成果类型: <input type=\"text\" name=\"achieveKind\" value=\"数据成果类型\"/></p>\n" +
            "        <p>数据成果名称: <input type=\"text\" name=\"achieveName\" value=\"数据成果名称\"/></p>\n" +
            "        <p>数据成果来源: <input type=\"text\" name=\"achieveFrom\" value=\"数据成果来源\" /></p>\n" +
            "        <p>数据成果版权方: <input type=\"text\" name=\"achieveCopyright\" value=\"数据成果版权方\" /></p>\n" +
            "        <p>创建人: <input type=\"text\" name=\"founder\" value=\"创建人\"/></p>\n" +
            "        <p>创建时间: <input type=\"datetime-local\" name=\"founderTime\" /></p>\n" +
            "        <p>数据成果格式: <input type=\"text\" name=\"format\" value=\"数据成果格式\"/></p>\n" +
            "        <p>成果描述: <input type=\"text\" name=\"descOfAchievs\" value=\"成果描述\"/></p>\n"

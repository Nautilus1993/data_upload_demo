 ...
 */
public class 航天技术试验领域元信息数据库表信息sub_004 {
...
//            }
            ...
            String file = "SADC_TGTH_20200817234411_20200817234411_20200817234411_20200817234411.dat";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            String subType = "sub_004";          // 数据小类：原始数据文件

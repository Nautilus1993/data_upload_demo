 ...
 */
public class 航天医学实验领域元信息数据库表信息sub_003 {
...
//            }
            ...
            String file = "SADC_TGTH_20200817234411_20200817234411_20200817234411_20200817234411.csv";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            String subType = "sub_003";          // 数据小类：原始数据文件

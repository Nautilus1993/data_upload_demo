...
import com.bjsasc.FTPClientSDK.model.entry.HTY.MicroHazardousGasFile;
 ...
 */
public class 微量气体检测装置数据文件表sub_045 {
    public static void main(String[] args) {
        ...
        try {
            ...
            //归档信息
            MicroHazardousGasFile dataResultAchieveReportFile = new MicroHazardousGasFile();
            dataResultAchieveReportFile.setCabin("数据成果格式");
            dataResultAchieveReportFile.setComment("数据成果名称");
            dataResultAchieveReportFile.setFileFullName("创建人");
            dataResultAchieveReportFile.setFileType("来源");
            dataResultAchieveReportFile.setFlyStage("类型");
            ...
            String subType = "sub_045";          // 数据小类：原始数据文件

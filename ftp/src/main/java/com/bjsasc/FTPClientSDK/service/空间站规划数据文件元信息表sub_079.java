 ...
 */
public class 空间站规划数据文件元信息表sub_079 {
...
//            }
            ...
            String file = "abcdabcdabcd_qwertyui_ZQRWGH_1111_12_1234_20201230061252_20201030061252_20201030061252.txt";
            ftpFiles.add(new FTPFile(file,localPath));

            // 上传文件
            String mainType = "main_021";     // 数据大类：归档数据
            String subType = "sub_079";          // 数据小类：原始数据文件

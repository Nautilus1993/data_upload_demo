 ...
 */
public class 空间环境预报数据通知描述信息sub_024 {
...
//            }
            ...
            String file = "SE_TGTH_FSKJH_XX_20201030215236_20201030215236_20201030215236.doc";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            // 上传文件
            String mainType = "main_016";     // 数据大类：归档数据
            String subType = "sub_024";          // 数据小类：原始数据文件

 ...
 */
public class 载荷工作计划等电文类数据元信息库表sub_007 {
...
//            }
            ...
            String file = "PA_TGTH_XX_XXXX_20201102231552_20201102231552_20201102231552.XML";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            // 上传文件
            String mainType = "main_004";     // 数据大类：归档数据
            String subType = "sub_007";          // 数据小类：原始数据文件

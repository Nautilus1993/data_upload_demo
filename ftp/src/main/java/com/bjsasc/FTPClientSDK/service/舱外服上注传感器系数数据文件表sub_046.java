...
import com.bjsasc.FTPClientSDK.model.entry.HTY.SpaceSuitSensorFile;
 ...
 */
public class 舱外服上注传感器系数数据文件表sub_046 {
    public static void main(String[] args) {
        ...
        try {
            ...
            //归档信息
            SpaceSuitSensorFile dataResultAchieveReportFile = new SpaceSuitSensorFile();
            dataResultAchieveReportFile.setFileFullName("数据成果格式");
            ...
            String subType = "sub_046";          // 数据小类：原始数据文件

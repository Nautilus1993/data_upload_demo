...
import com.bjsasc.FTPClientSDK.model.entry.HTY.MedicalTestFile;
 ...
 */
public class 航天医学实验数据文件表sub_044 {
    public static void main(String[] args) {
        ...
        try {
            ...
            //归档信息
            MedicalTestFile dataResultAchieveReportFile = new MedicalTestFile();
            dataResultAchieveReportFile.setCabin("数据成果格式");
            dataResultAchieveReportFile.setComment("数据成果名称");
            dataResultAchieveReportFile.setDeviceId((short)1);
            dataResultAchieveReportFile.setFileType("来源");
            dataResultAchieveReportFile.setFileFullName("来源");
            dataResultAchieveReportFile.setItemId((short)1);
            dataResultAchieveReportFile.setIndentity("版权方");
            dataResultAchieveReportFile.setFlyStage("描述");
            dataResultAchieveReportFile.setFileTime(new Date());
            ...
            String subType = "sub_044";          // 数据小类：原始数据文件

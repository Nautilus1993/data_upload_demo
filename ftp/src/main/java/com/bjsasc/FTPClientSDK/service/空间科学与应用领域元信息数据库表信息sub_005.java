 ...
 */
public class 空间科学与应用领域元信息数据库表信息sub_005 {
...
//            }
            ...
            String file = "SADC_TGTH_AABBCC_20200817234411_20200817234411_20200817234411_20200817234411.csv";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            // 上传文件
            String mainType = "main_003";     // 数据大类：归档数据
            String subType = "sub_005";          // 数据小类：原始数据文件

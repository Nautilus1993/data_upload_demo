 ...
 */
public class 空间环境预报数据文件元信息数据库表信息sub_006 {
...
//            }
            ...
            String file = "SE_TGTH_CQYBPG_ABCD_20201102231552_20201102231552_20201102231552.CQYBPG";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            String subType = "sub_006";          // 数据小类：原始数据文件

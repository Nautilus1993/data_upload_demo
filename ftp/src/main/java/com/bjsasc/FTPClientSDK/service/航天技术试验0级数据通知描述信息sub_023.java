 ...
 */
public class 航天技术试验0级数据通知描述信息sub_023 {
    public static void main(String[] args) {

        String USERNAME = "test_user_2";  //用户名test_user_3
...
//            }
            ...
            String file = "SADC_TGTH_20201030142553_20201030142553_20201030142553_20201030142553.dat";
...
//            ftpFiles.add(new FTPFile(file,localPath));
            ...
            // 上传文件
            String mainType = "main_015";     // 数据大类：归档数据
            String subType = "sub_023";          // 数据小类：原始数据文件
